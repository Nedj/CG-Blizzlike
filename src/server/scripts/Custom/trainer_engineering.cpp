        ...
        switch (uiAction) {
            case GOSSIP_ACTION_INFO_DEF + 1: // Learn Engineering
                ...
                if (pPlayer->HasSpell(51306) == true) {
                    ...
                    uint16 maxLevel = pPlayer->GetPureMaxSkillValue(SKILL_ENGINERING);
                    pPlayer->SetSkill(SKILL_ENGINERING, pPlayer->GetSkillStep(SKILL_ENGINERING), maxLevel, maxLevel);
                    ...
                    pCreature->MonsterWhisper("You have succesfully learned Engineering!", pPlayer->GetGUID());
                }
                break;
...
void AddSc_Script_TEngineering() {
