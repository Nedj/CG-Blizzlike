        ...
        switch (uiAction) {
            case GOSSIP_ACTION_INFO_DEF + 1: // Learn Jewelcrafting
                ...
                if (pPlayer->HasSpell(51311) == true) {
                    ...
                    uint16 maxLevel = pPlayer->GetPureMaxSkillValue(SKILL_JEWELCRAFTING);
                    pPlayer->SetSkill(SKILL_JEWELCRAFTING, pPlayer->GetSkillStep(SKILL_JEWELCRAFTING), maxLevel, maxLevel);
                    ...
                    pCreature->MonsterWhisper("You have succesfully learned Jewelcrafting!", pPlayer->GetGUID());
                }
                break;
...
void AddSc_Script_TJewelcrafting() {
