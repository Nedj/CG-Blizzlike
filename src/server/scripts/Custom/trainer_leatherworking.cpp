        ...
        switch (uiAction) {
            case GOSSIP_ACTION_INFO_DEF + 1: // Learn Leatherworking
                ...
                if (pPlayer->HasSpell(51302) == true) {
                    ...
                    uint16 maxLevel = pPlayer->GetPureMaxSkillValue(SKILL_LEATHERWORKING);
                    pPlayer->SetSkill(SKILL_LEATHERWORKING, pPlayer->GetSkillStep(SKILL_LEATHERWORKING), maxLevel, maxLevel);
                    ...
                    pCreature->MonsterWhisper("You have succesfully learned Leatherworking!", pPlayer->GetGUID());
                }
