        ...
        switch (uiAction) {
            case GOSSIP_ACTION_INFO_DEF + 1: // Learn Enchanting
                ...
                if (pPlayer->HasSpell(51313) == true) {
                    ...
                    uint16 maxLevel = pPlayer->GetPureMaxSkillValue(SKILL_ENCHANTING);
                    pPlayer->SetSkill(SKILL_ENCHANTING, pPlayer->GetSkillStep(SKILL_ENCHANTING), maxLevel, maxLevel);
