...
class boss_ragefire_custom : public CreatureScript
{
public:
    boss_ragefire_custom() : CreatureScript("boss_ragefire_custom") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new boss_ragefire_customAI(creature);
    }

    struct boss_ragefire_customAI : public ScriptedAI
    {
        boss_ragefire_customAI(Creature* creature) : ScriptedAI(creature)
        {
