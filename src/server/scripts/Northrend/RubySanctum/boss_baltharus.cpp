...
class boss_baltharus_custom : public CreatureScript
{
public:
    boss_baltharus_custom() : CreatureScript("boss_baltharus_custom") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new boss_baltharus_customAI(creature);
    }

    struct boss_baltharus_customAI : public ScriptedAI
    {
        boss_baltharus_customAI(Creature* creature) : ScriptedAI(creature)
        {
        ...
        void Reset()
        {
            ...
            if(Creature* target = me->GetMap()->GetCreature( pInstance->GetData64(NPC_XERESTRASZA)))
...
class mob_baltharus_clone_custom : public CreatureScript
{
public:
    mob_baltharus_clone_custom() : CreatureScript("mob_baltharus_clone_custom") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new mob_baltharus_clone_customAI(creature);
    }

    struct mob_baltharus_clone_customAI : public ScriptedAI
    {
        mob_baltharus_clone_customAI(Creature* creature) : ScriptedAI(creature)
        {
            pInstance = (InstanceScript*)creature->GetInstanceScript();
            Reset();
        }
...
class mob_xerestrasza_custom : public CreatureScript
{
public:
    mob_xerestrasza_custom() : CreatureScript("mob_xerestrasza_custom") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new mob_xerestrasza_customAI(creature);
    }

    struct mob_xerestrasza_customAI : public ScriptedAI
    {
        mob_xerestrasza_customAI(Creature* creature) : ScriptedAI(creature)
        {
            pInstance = (InstanceScript*)creature->GetInstanceScript();
            Reset();
        }
...
{
    new boss_baltharus_custom();
    new mob_baltharus_clone_custom();
    new mob_xerestrasza_custom();
}
